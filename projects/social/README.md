...
Answer: 500 times. This is because the total number of friendships is 100 \* 10 = 1000, and every call to `add_friendship()` creates two new "friendships" (friendships are bi-directional). 1000 / 2 = 500.
