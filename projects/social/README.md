...
Answer: ~86% of other users will be in a particular user's extended social network.
The average degree of separation between a user and those in his/her extended network is ~4.4.
